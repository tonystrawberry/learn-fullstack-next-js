...
export async function getStaticPaths() {
  ...
  return {
    fallback: false, // if false then that means we have provided all the possible paths in 'paths' and that any other provided path will result in a 404 error page
